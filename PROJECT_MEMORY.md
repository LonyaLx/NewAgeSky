# 天工创世 · 项目记忆（2026-09-10）

## 当前状态
- 桌面包：`C:\Users\admin\Desktop\NewAgeSky-1.21.1`
- 测试实例：`D:\我的世界整合包\1\versions\测试`
- Minecraft 1.21.1 + NeoForge 21.1.249 + Java 21；mods 216。
- 游戏窗口标题：《天工创世》--凉寻Lonya。
- FTB Quests：29 章、945 个任务、2 个奖励表、34 个任务文件；最终目标已有 19 个创造链任务。
- 不安装 data_energistics、Refined Storage、apothicenchantingaddition。
- 渲染组合：Sodium + Iris。
- 最终目标章节已重做为 19 个连续创造链任务，最终目标为 ME 创造存储元件。

## 当前任务线
- 主线 1–5 各 40 个具体物品任务，共 200 个。
- 主线内部 0 重复，与其他 24 个专题章节物品重叠 0。
- 每章 8 阶段、每阶段 5 个顺序任务。
