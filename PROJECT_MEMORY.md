...
## 下次继续
- 用 PCL/HMCL 实际导入 `天工创世-发布/01-整合包/天工创世-1.0.1-CurseForge.zip`，验证 165 个远程模组下载和 53 个内置模组安装。
...
- 唯一安装包：`01-整合包/天工创世-1.0.1-CurseForge.zip`，78.41 MB；165 个模组由启动器下载，53 个随包提供。
